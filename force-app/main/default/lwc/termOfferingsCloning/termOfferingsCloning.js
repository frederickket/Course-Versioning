...
import TERM_OFFERINGS_CLONING_TEXT_1 from '@salesforce/label/c.Term_Offerings_Cloning_Text_1';
import TERM_OFFERINGS_CLONING_TEXT_2 from '@salesforce/label/c.Term_Offerings_Cloning_Text_2';
import TERM_OFFERINGS_CLONING_TEXT_3 from '@salesforce/label/c.Term_Offerings_Cloning_Text_3';
...
//Lightning modal
import termOfferingsCloningModal from 'c/termOfferingsCloningModal';
...
//Apex method
import ctrlGetJobQueueData from '@salesforce/apex/REDU_TermOfferingsCloning_LCTRL.getJobQueueData';

export default class TermOfferingsCloning extends LightningElement {
    ...
    //label
    label = {
        TERM_OFFERINGS_CLONING_WIZARD_NAME,
        TERM_OFFERINGS_CLONING_TEXT_1,
        TERM_OFFERINGS_CLONING_TEXT_2,
        TERM_OFFERINGS_CLONING_TEXT_3,
    ...
    */
    handleNewClick() {
        try{
            termOfferingsCloningModal.open({
                size: 'small',
                recordId: this.recordId,
    ...
    */
     ...
     */
    handleHelpClick(){
        termOfferingsCloningHelpModal.open({
            enableDebugMode: this.enableDebugMode
        }).then(result=>{
    ...
    /**
     * @description Return termOfferingsCloningWizardText1 label
     */
    get termOfferingsCloningWizardText1() {
        return this.label.TERM_OFFERINGS_CLONING_TEXT_1.format([this.label.TERM_OFFERINGS_CLONING_WIZARD_NAME]);
    }

    /**
     * @description Return termOfferingsCloningWizardText2 label
     */
    get termOfferingsCloningWizardText2() {
        return this.label.TERM_OFFERINGS_CLONING_TEXT_2;
    }

    /**
     * @description Return termOfferingsCloningWizardText3 label
     */
    get termOfferingsCloningWizardText3() {
        return this.label.TERM_OFFERINGS_CLONING_TEXT_3.format([this.label.TERM_OFFERINGS_CLONING_WIZARD_NAME]);
    }
	...
	consoleLog(anything, isJson){
        logInfo('TermOfferingsCloning', anything, this.enableDebugMode, isJson);
    }
}